...
The transaction validated, and I saw the wage had been deducted from the first account address.
![alt=""](Images/2-jo-first-hash.png)

The transaction did not deduct from any other account on Ganache. I realized that using the stock addresses given in the starter code I wouldn't be able to see any of the wages added to the developer's accounts. To address this I changed out the addresses with other addresses in my Ganache session.

I then ran another transaction to Jo, this time for 23 hours of work, and saw the wages deducted from my account and added to Jo's new account address.
